...
\begin{longtable}{p{0.4in} p{5.8in}}
 \justifying
 2015 & The JCSDA Colloquium on Satellite Data Assimilation,
...
Spectroscopy and Radiative Transfer}, 2016, In press. \\
...
(\textbf{17 reviews on 15 manuscripts for 13 journals}) \\
\textit{Aerosol and Air Quality Research}: 2015(2) \\
\textit{Atmosphere}: 2016(1) \\
\textit{Atmospheric Environment}: 2016(1) \\
...
\textit{Remote Sensing of Environment}: 2016(1) \\
...
(\textbf{2 reviews for 1 conference}) \\
