\documentclass[11.5pt, letterpaper]{article}   	% use "amsart" instead of "article" for AMSLaTeX format
\usepackage[left=1.0in,top=1.0in,right=1.0in,bottom=1.0in]{geometry}                		% See geometry.pdf to learn the layout options. There are lots.
...
\usepackage{scrextend} % to use the 'addmargin' environment
...
\fancyfoot[LE,RO]{Page \thepage}     % page number in "outer" position of footer line
\fancyfoot[RE,LO]{Xiaoguang Xu, Curriculum Vitae} % other info in "inner" position of footer line
...
\sectionlineskip
%\hrule
\begin{addmargin}[1.35in]{0cm}
My research areas have focused on retrieval and assimilation of aerosol 
remote sensing data, with emphasis on the integration of satellite remote
sensing and numerical chemistry transport model
(e.g. GEOS-Chem) to characterize aerosol distribution and emitting
sources. In specific, I developed the capability to use GEOS-Chem adjoint for
inverse modeling of dust emissions, with which the 4D-Var
method was used to constrain speciated aerosol sources from remote sensing data.
I am also the major developer of a numerical testbed for remote
sensing of aerosol, the Unified Linearized Vector Radiative Transfer
Model (UNL-VRTM). I am interested in developing retrieval algorithms for both 
satellite sensors (such as MODIS and EPIC) and ground based polarimetric 
(AERONET) remote sensing platforms.
\end{addmargin}
...
%\sectionlineskip
%\hrule
\renewcommand{\arraystretch}{1.35}  % Add extra space between rows
\begin{longtable}{p{1.1in} p{5.1in}}
...
\begin{longtable}{p{1.1in} p{5.1in}}
 \justifying
2016.09--Present & Assistant Research Scientist, The University of Iowa
\\
2016.01--2016.08 & Research Assistant Professor, University of
Nebraska-Lincoln \\
2015.09--2015.12 & Postdoctoral Scholar, University of Nebraska-Lincoln \\
...
Research (NCAR) \\
2008.08--2015.08 & Graduate Research Assistant, University of
Nebraska-Lincoln\\
2006.07--2008.07  & Graduate Researcher, National Climate Center, China
...
\begin{longtable}{p{1.1in} p{5.1in}}
 \justifying
Co-Lecturer & Satellite Image Processing \& Remote
Sensing of Atmosphere, U. Iowa (2017 Spring)\\
Guest Lecturer & Advanced Satellite Remote Sensing, 
U. Nebraska (2012 Fall, 2015 Fall) \\
Guest Lecturer & Physical Meteorology, U. Nebraska (2015 Fall) \\
Lead & Inverse Modeling \& Optimization Discussion Series, 
U. Nebraska (2014 Spring) \\
Teaching Assistant & Environment, Energy, and Climate, 
U. Nebraska (2013 Fall) \\
Teaching Assistant & Atmospheric Thermodynamics, U. Nebraska (2012 Spring)
\end{longtable}
...
\begin{longtable}{p{1.1in} p{5.1in}}
 \justifying 
 2014 & Outstanding Graduate Award, UNL Earth \& Atmospheric Sciences \\
 2012--2015 & NASA Earth and Space Science Fellowship \\
 2007 & Outstanding Conference Paper, China Meteorological
Society Annual Meeting \\
 2004 & Outstanding Undergraduate, Lanzhou University
\end{longtable} 
...
\begin{longtable}{p{1.1in} p{5.1in}}
 \justifying
2018.03--2021.03 & Characterization of Global Aerosol Height Using Satellite
Observations in Oxygen A and B bands \quad (\$262,992, Pending) \newline
\hspace{.5cm} -- Sponsor: NASA (NNH17ZDA001N-NIP) \newline
\hspace{.5cm} -- Role: PI \\

2017.12--2020.11 & Constraining Dust Refractive Index and Direct 
Radiative Forcing Using Paired Sounder/Imager Sensors on Aqua and SNPP 
\quad (\$554,836, Pending) \newline
\hspace{.5cm} -- Sponsor: NASA (NNH17ZDA001N-TASNPP) \newline
\hspace{.5cm} -- Role: PI \\

2017.02--2020.02 & Multi-phase inversion of aerosol sources using 
MODIS, MISR, OMI, and AERONET data and the GEOS-Chem adjoint \quad 
(\$809,486) \newline
\hspace{.5cm} -- Sponsor: NASA (NNH16ZDA001N-ACMAP) \newline
\hspace{.5cm} -- Role: Co-I (Dr. Daven Henze is the PI) \\

2014.11--2017.10 & Sensitivity analysis and recovery of dust emissions from
spectral climate signals \quad (\$539,721) \newline
\hspace{.5cm} -- Sponsor: NASA (NNH14ZDA001N-ACSCS) \newline
\hspace{.5cm} -- Role: Co-I (Dr. Jun Wang is the PI) \\

2012.09--2015.08 & Constraining Global Sources of Atmospheric Mineral Dust with
...
\newline
\hspace{.5cm} -- Role: Awarded Graduate Fellow
\end{longtable}
...
\sectionskip
{\bf\large Journal Publications (Total: 25)}
\sectionlineskip
\hrule
\begin{longtable}{p{0.6in} p{5.6in}}
 \justifying 
 2017 & Hou, W., Z. Li, J. Wang, \underline{X. Xu}, P. Goloub, and L. Qie,
\textbf{Improving remote sensing of aerosol microphysical properties 
by near-infrared polarimetric measurements over vegetated land: 
Information content analysis}, \textit{J. Geophys. Res. Atmos.}, 
Submitted. \\
...
\begin{addmargin}[0.3in]{0cm}
\textit{Aerosol and Air Quality Research}: \hfill 2015(2), 2016(1) \\
\textit{Atmosphere}: \hfill 2016(4) \\
\textit{Atmospheric Chemistry and Physics}: \hfill 2016(1), 2017(2) \\
\textit{Atmospheric Environment}: \hfill 2016(2) \\
\textit{Frontiers of Earth Science}: \hfill 2014(1) \\
\textit{Geoscientific Model Development}: \hfill 2017(1) \\
\textit{International Journal of Environmental Research and Public
Health}: \hfill 2016(1) \\
\textit{International Journal of Remote Sensing}: \hfill 2014(1) \\
\textit{Journal of Atmospheric and Solar-Terrestrial Physics}:
2015(1), 2016(1) \\
\textit{Journal of Geophysical Research}: \hfill 2013(2), 2016(1), 2017(4) \\
\textit{Journal of Quantitative Spectroscopy and Radiative Transfer}:
\hfill 2015(1), 2016(1) \\
\textit{Remote Sensing}: \hfill 2016(1), 2017(6) \\
\textit{Remote Sensing of Environment}: \hfill 2016(5), 2017(3) \\
\textit{Science of the Total Environment}: \hfill 2016(2), 2017(1) \\
\textit{Southeastern Geographer}: \hfill 2016(1) \\
\textit{Theoretical and Applied Climatology}: \hfill 2012(1), 2013(1), 2015(1)
\\
\textit{Water, Air, \& Soil Pollution}: \hfill 2017(1)
\end{addmargin}
...
\hrule
\begin{addmargin}[0.3in]{0cm}
Fortran, IDL, Python, LaTex, Html, PHP, Linux
\end{addmargin}
